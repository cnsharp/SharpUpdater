...
namespace CnSharp.Windows.Updater
{
    public partial class ConnectionForm : BaseForm
    {
        ...
        {
            //var feedUrl = $"{LocalManifest.ReleaseUrl}/GetUpdates()?packageIds='{LocalManifest.Id}'&versions='{LocalManifest.Version}'&includePrerelease=false";
            var feedUrl = $"{LocalManifest.ReleaseUrl}/Search()?$filter=IsLatestVersion&searchTerm='{LocalManifest.Id}'&includePrerelease=false";
        ...
        private void WorkerOnRunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                Application.Exit();
                Common.Start(LocalManifest, e.Error);
                return;
            }
