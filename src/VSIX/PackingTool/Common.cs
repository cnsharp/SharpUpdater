...
namespace CnSharp.VisualStudio.SharpDeploy
{
    public class Common
    {
        ...
        public static bool CheckTfs(Project project)
        {
            ...
            return Host.Instance.SourceControl != null;
        }
    ...
    public class Paths
    {
        ...
        public static string GetNuPackSettingsLocation(Project project)
        {
           var dir = Path.GetDirectoryName(Host.Instance.DTE.Solution.FileName);
           return $"{dir}\\_nupack\\{project.FullName.MD5()}\\settings.xml";
        }
    }
