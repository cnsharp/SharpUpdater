...
{
    /// <summary>
    /// Copy from https://github.com/NuGet/NuGet2/blob/main/src/Core/Utility/UriUtility.cs
    /// </summary>
    public static class UriUtility
    {
        ...
        public static string GetPath(Uri uri)
        {
            ...
            // We need the unescaped uri string to ensure that all characters are valid for a path.
